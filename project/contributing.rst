...
#################################################################
Contributing to Rubin Observatory Risk Management Tool User Guide
#################################################################

.. This section should provide a brief, top-level description of the page.

Below are instructions and guidelines on contributing to the :doc:`Rubin Observatory Risk Management Tool User Guide </index>`.
This documentation is built with `Sphinx <https://www.sphinx-doc.org/en/master/>`__ and published to :doc:`https://rtn-051.lsst.io </index>`.
...
If you spot an issue with the documentation, the best thing to do is `raise a GitHub issue in the rtn-051 repo <https://github.com/lsst/rtn-051/issues/new>`__.
...
You can contribute directly to the `rtn-051 repo <https://github.com/lsst/rtn-051>`__ by creating a pull request (PR).
...
#. Notify Austin Roberts the PR was merged.
...
.. include:: documentation-rtn-051-style-guide.inc
